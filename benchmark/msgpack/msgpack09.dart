...
class MessagePack {
  ...
  static final SendPort _packPort = spawnFunction(packIsolate);
  static final SendPort _unpackPort = spawnFunction(unpackIsolate);
...
//  static ListOutputStream pack(arg) {
//    ListOutputStream ret = new ListOutputStream();
//    _write(ret, arg);
//    return ret;
//  }
...
class ByteArrayOutput implements Output {
  ...
  writeDouble(double d) {
    int offset = 8;
    _reserve(offset);
    ByteArray view = buffer.asByteArray(idx, offset);
    _buff64.asByteArray().setFloat64(0, d);
    view.setUint8(0, _buff64View().getUint8(7));
    view.setUint8(1, _buff64View().getUint8(6));
    view.setUint8(2, _buff64View().getUint8(5));
    view.setUint8(3, _buff64View().getUint8(4));
    view.setUint8(4, _buff64View().getUint8(3));
    view.setUint8(5, _buff64View().getUint8(2));
    view.setUint8(6, _buff64View().getUint8(1));
    view.setUint8(7, _buff64View().getUint8(0));
    idx+=offset;
  }
  ...
  writeByteAndDouble(int b, double d) {
    ...
    _buff64.asByteArray().setFloat64(0, d);
    view.setUint8(0, b);
    view.setUint8(1, _buff64View().getUint8(7));
    view.setUint8(2, _buff64View().getUint8(6));
    view.setUint8(3, _buff64View().getUint8(5));
    view.setUint8(4, _buff64View().getUint8(4));
    view.setUint8(5, _buff64View().getUint8(3));
    view.setUint8(6, _buff64View().getUint8(2));
    view.setUint8(7, _buff64View().getUint8(1));
    view.setUint8(8, _buff64View().getUint8(0));
    idx+=offset;
  }
}
/*
...
class BufferOutput implements Output {
  BufferOutput(List buff, Callback expander) {
    buffer = buff;
    expandCallback = expander;
  }
  List buffer;
  ...
  _expand(int len) {
    buffer = expandCallback(buffer, len);
  }
  static _writeInt64(List<int> out, int d) {
    _byte64.setUint64(0, d);
    out.add(int64Type);
